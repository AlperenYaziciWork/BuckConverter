...
#define COM_VOLTAGE_CURRENT_SYSTEM_INFO_MESSAGE_TIMER_ID 1U // used 1 timer base for all defined messages 
...
#define SYSTEM_TEMPERATURE_PROCESS_TIMER_ID 2U
#define SOFTWARE_TIMER_CNT 3U
